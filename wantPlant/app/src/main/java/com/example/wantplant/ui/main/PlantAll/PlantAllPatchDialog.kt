...
class PlantAllPatchDialog(context: Context, plantAllInterface: PlantAllInterface, val clickTodoId: Long, var clickTodoTitle: String, var clickTodoDate: String, var clickTodoTime: String, var clickTodoGoalTitle: String): Dialog(context) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.dialogWaterWeekDeleteTv.setOnClickListener {
            ...
            this.plantAllInterface?.onDeleteClicked()
        ...
        binding.dialogWaterWeekCompleteTv.setOnClickListener {
            ...
            this.plantAllInterface?.onPatchClicked()
    ...
    private fun deleteTodoAPI(todoId: Long) {
        val sharedPref = context?.getSharedPreferences("TOKEN", Context.MODE_PRIVATE)
        val accessToken = sharedPref?.getString("accessToken", "")
        Log.d("Retrofit 할 일 삭제", "사용된 액세스 토큰: Bearer $accessToken")
