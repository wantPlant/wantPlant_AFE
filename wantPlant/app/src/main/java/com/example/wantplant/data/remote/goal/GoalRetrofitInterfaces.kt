...
interface GoalRetrofitInterfaces {
    ...
    @GET("/api/goals/todos")
    fun getPotGoalTodo(@Header("Authorization") token: String?, @Query(value = "potId") potId: Long): Call<GoalGetResponse>
    ...
    fun deleteGoal(@Header("Authorization") token: String?, @Path(value = "goalId") goalId: Long): Call<GoalDeleteResponse>
