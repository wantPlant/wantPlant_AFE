...
//
//        getMonthTagAPI(year, month, holder, tempMonth)
//
//    }
//
...
//    }
//
//    private fun getMonthTagAPI(year: Int, month: Int, holder: ViewHolder, tempMonth: Int) {
//        val tagService = getRetrofit().create(TagRetrofitInterfaces::class.java)
//
//        tagService.getMonthTag(year, month).enqueue(object: Callback<TagGetMonthResponse>
//        {
...
//                var dayList: MutableList<MonthDate> = MutableList(6 * 7) { Date(),  }
//                for(i in 0..5) {
//                    for(k in 0..6) {
