...
interface TodoRetrofitInterfaces {
    ...
    fun patchTodoComplete(@Header("Authorization") token: String?,@Path(value = "todoId") todoId: Long, todoPatchCompleteRequest: TodoPatchCompleteRequest): Call<TodoPatchCompleteResponse>
}